    ...
    return (
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-6">
          {[...Array(6)].map((_, i) => {
            const randomHeight = [64, 96, 128, 160][
            ...
            return (
              <div key={i} className="break-inside-avoid mb-6">
                <div
                  className={`animate-pulse rounded-2xl bg-gradient-to-br ${randomGradient} p-6 border border-white shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] backdrop-blur-sm`}
                >
                  ...
                  <div
                    className={`h-${randomHeight} bg-white/40 rounded-lg mb-4`}
                  ></div>
